  ...
  return (
    <DataContext.Provider
      value={{
        ...
        navIsOpen,
        setNavIsOpen,
        isSearching: [searching, setSearching],
        modal: [toggleModal, setToggleModal],
        trackedVehicle,
        userData: [user, setUser],
        logData,
        setLogData,
        daily: [dailyShipments, setDailyShipments],
        shipmentsMenu: [activeShipmentsMenu, setActiveShipmentsMenu],
        monthly: [monthlyShipments, setMonthlyShipments],
        yearly: [yearlyShipments, setYearlyShipments],
      }}
    >
      {props.children}
    </DataContext.Provider>
