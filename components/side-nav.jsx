...
const SideNav = () => {
  ...
  return (
    <nav className="h-full">
      <div
        className="flex justify-end lg:hidden mb-2 text-3xl font-extrabold text-slate-800 dark:text-white"
        onClick={closeNav}
      >
        <MdClose />
      </div>
      <h1 className="px-5 font-bold text-2xl mb-5 dark:text-white">
        AMINCI<span className="text-blue-600">.</span>
      </h1>
      <ul className="scroll-smooth">
        ...
        <NavLink location="" navIcon={<TiHome />} href="/" aTag="Home" />
